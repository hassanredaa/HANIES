...
export default function Clothesss() {
    ...
    return (
      <div className="shopping-page">
        <header className="header">
          <h1>Winter Coats for Children</h1>
        </header>
        <main className="mainm">
          <div className="productm">
            ...
            <p>Season: {organizationRequests.clothes[0].season}</p>
            <p>Material: {organizationRequests.clothes[0].material}</p>
            <p>Quantity Needed: {organizationRequests.clothes[0].quantity}</p>
